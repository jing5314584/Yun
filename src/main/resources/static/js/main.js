...
;(function(){
    function obj(){
        ...
        wx_share={
            ...
            image:"https://static2.flowerplus.cn/Static/img/flowerpluslogo2.jpg",
            link:"https://t.flowerplus.cn",
        ...
        this.toDate=function(str){
            ...
            var reg = new RegExp(/(?:(\d{4})年)?(\d{1,2})月(\d{1,2})[日号]/);
            ...
            return {
                'date': newDate,
                'date_text': String(month+1)+"月"+String(date)+"号",
                'week_text': week[day]
            }
        },
        ...
        function drawQrImg(obj){
            ...
            if(obj.url){
                qr_image.onload = function(){
                    ...
                    ctx.save();
                    if(obj.circle){
                        ctx.translate(obj.circle.l,obj.circle.t);
                        ctx.arc(obj.circle.r * 2, obj.circle.r * 2, obj.circle.r, 0, 2 * Math.PI)
                        ctx.clip();
                        ctx.drawImage(qr_image,obj.circle.r, obj.circle.r, obj.circle.r * 2, obj.circle.r * 2);
                    }else{
...
FP.setCookie = function (c_name, value, expiredays, path, domain) {
    var exdate=new Date();
...
FP.loading = function(msg){
  var tips = $(".tips");
  msg = msg || '加载中...';
  if(tips.length == 0){
    tips = $("<div class=\"tips\"></div>").appendTo("body");
  }
  tips.html("<div>"+msg+"</div>");
  return {
    show : function (){
        tips.show()
    },
...
if(typeof window.getQueryString == 'undefined'){
  window.getQueryString = FP.getQueryString;
}
...
var categoryType = {
    '/activity/activity_plants':{
        pageCategory1:'商城',
        pageCategory2:'商城首页',
        pageCategory3:'花加绿植'
    },
    '/f/h6bBRbnt20672.html' : {
        pageCategory1:'商城',
        pageCategory2:'商品详情页',
        pageCategory3:'简花'
    },
    ...
    '/f/DHbDIr1i20847.html' : {
        pageCategory1:'商城',
        pageCategory2:'商品详情页',
        pageCategory3:'悦花'
    },
    '/f/oOs52KKR20849.html' : {
        pageCategory1:'商城',
        pageCategory2:'商品详情页',
        pageCategory3:'繁花'
    },
    ...
    '/f2229' : {
        pageCategory1:'商城',
        pageCategory2:'商品详情页',
        pageCategory3:'MiniPlus'
    },
    '/f20165' : {
        pageCategory1:'商城',
        pageCategory2:'商品详情页',
        pageCategory3:'MiniRose'
    },
    '/v/buy.confirm.html' : {
        pageCategory1:'商城',
        pageCategory2:'购买流程',
        pageCategory3:'订单信息确认'
    },
    '/my/order_success' : {
        pageCategory1:'商城',
        pageCategory2:'购买流程',
        pageCategory3:'订单支付成功'
    },
    '/my' : {
        pageCategory1:'服务',
        pageCategory2:'会员中心',
...
var pro_pathName = window.location.pathname;
if (pro_pathName.substring(pro_pathName.length-1,pro_pathName.length)=="/") {
    pro_pathName = pro_pathName.substr(0,pro_pathName.length-1)
} else {
    pro_pathName = pro_pathName;
}

var defaultValue = pro_pathName + window.location.hash;
var fp_info = {
    pageCategory1 : defaultValue,
    pageCategory2 : defaultValue,
    pageCategory3 : defaultValue
};

var category = categoryType;
if (location.pathname == '/') {
    fp_info.pageCategory1 = '商城';
    fp_info.pageCategory2 = '商城首页';
    var mall_category = mallCategory;

    // set home page hash's PageCategory3
    setHomeHashPageCategory3();
}else{
    var page_category = categoryType;

    if (pro_pathName == '/my/orders') {
      ...
      if (page_category[pro_pathName] !== undefined) {
        fp_info = page_category[pro_pathName];
      }
    }
}
...
/**
 * set home page hash's PageCategory3
 * @author wuzhengping <wuzhengping@flowerplus.cn>
 */
function setHomeHashPageCategory3() {
    var hashVal = window.location.hash.substring(1);
    if (mall_category.hasOwnProperty(hashVal)) {
        fp_info.pageCategory3 = mall_category[hashVal];
    }
}
