...
public class ConfigUtil {
	 ...
	 * 服务号相关信息
	 */
	public final static String APPID = LoadProperties.getPayProperty("wx_app_id");// 应用号
//	public final static String APP_SECRECT = "861998ab708c1aa7fb4dc265188511de";// 应用密码
	// public final static String TOKEN = "weixinCourse";//服务号的配置token
	public final static String MCH_ID = LoadProperties.getPayProperty("wx_mch_id");// 商户号 xxxx 公众号商户id
														// xxxxx
	public final static String API_KEY = LoadProperties.getPayProperty("wx_key");// API密钥
...
//	public final static String NOTIFY_URL = "https://pay-test1.xxxxxx.com/weixin/pay/callback/pay.action";
	// 正式服 使用如下
	public final static String NOTIFY_URL = LoadProperties.getPayProperty("wx_notify_url");
	public final static String NOTIFY_URL_ZFB = LoadProperties.getPayProperty("zfb_notify_url");
...
//	public final static String REDIRECT_URI = "http://14.117.25.80:8016/GoMyTrip/a.jsp?port=8016";
	 ...
	 */
	// 微信支付统一接口(POST)							
	public final static String UNIFIED_ORDER_URL = LoadProperties.getPayProperty("wxPayUrl");
	// 微信退款接口(POST)
